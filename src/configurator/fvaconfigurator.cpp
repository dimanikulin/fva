...
FVAConfigurator::FVAConfigurator(QWidget* parent) : QDialog(parent) {
    ui.setupUi(this);
...
#else
#ifdef FVA_LANGUAGE_ENG
    QCheckBox* picsByModifTimeCheckBox =
        new QCheckBox(tr("shall be renamed pictures files using \nthe file modification time \nif they do not have "
                         "exif taken time set"));
    QCheckBox* videoByModifTimeCheckBox = new QCheckBox(
        tr("shall be renamed video files using \nthe file modification time \nif they do not have taken time set"));
