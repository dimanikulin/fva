...
/*!
 * \brief CLTRenameFiles is child of CmdLineBaseTask and it renames files by their metadata (like EXIF date-time taken)
 * or modificatrion date In read only mode this cmd just checks if renaming is even possible
 */
