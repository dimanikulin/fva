...
/*!
 * \brief CLTMoveInputDir2Output is child of CmdLineBaseTask and it moves (if readonly is YES) or copies (if readonly is
 * NO) input folder content into output foder
 */
