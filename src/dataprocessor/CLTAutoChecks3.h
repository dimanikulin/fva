 ...
 *
 * 1. it checks for existing device in fva info by fileName-returns FVA_ERROR_NO_DEV_ID and
 * FVA_ERROR_NON_UNIQUE_FVA_INFO
 * 2. it checks for existing device in dictionary by device name in pictire-returns FVA_ERROR_UNKNOWN_DEVICE,
 * FVA_ERROR_EMPTY_DEVICE, FVA_ERROR_LINKED_WRONG_DEVICE
