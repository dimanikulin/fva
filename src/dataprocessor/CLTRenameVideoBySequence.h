...
/*!
 * \brief CLTRenameVideoBySequence is child of CmdLineBaseTask and it renames video files by their sequence formatted in
 * file name In read only mode this cmd just checks if renaming is even possible
 */
