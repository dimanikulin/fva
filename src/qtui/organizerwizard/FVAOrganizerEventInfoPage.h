...
/*!
 * \brief FVAOrganizerEventInfoPage is a child of <a href="https://doc.qt.io/qt-5/qwizardpage.html">QWizardPage</a> and
 * implements the next UI functions:
 *
...
private:
    ...
    /*!
     * \brief  maps input dir structure (folder names and file names) to people ids (that caused the event) got from
     * fvaPeople.csv
     */
