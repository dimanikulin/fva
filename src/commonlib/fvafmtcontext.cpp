...
FVA_EXIT_CODE FvaFmtContext::fillFmtContextFromCfg(const FvaConfiguration& cfg) {
    ...
    if (FVA_NO_ERROR != res) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::fvaDirName' from configuration.";
        return res;
    }
    ...
    if (FVA_NO_ERROR != res) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::fvaDirNameYear' from configuration.";
        return res;
    }
    ...
    if (FVA_NO_ERROR != res) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::fvaFileName' from configuration.";
        return res;
    }
    ...
    if (FVA_NO_ERROR != res) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::exifDateTime' from configuration.";
        return res;
    }
    ...
    if (FVA_NO_ERROR != res) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::riffDateTime1' from configuration.";
        return res;
    }

    if (FVA_NO_ERROR != cfg.getParamAsString("Format::riffDateTime2", riffDateTime2)) {
        LOG_CRIT
            << "FvaFmtContext::fillFmtContextFromCfg: Can't get parameter 'Format::riffDateTime2' from configuration.";
        return res;
    }
    return FVA_NO_ERROR;
}
