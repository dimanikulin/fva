...
enum FVA_EXIT_CODE {
    ...
    FVA_ERROR_LINKED_WRONG_DEVICE = 1054,
    FVA_ERROR_FAILED_TO_ENUMERATE_DIR = 1055,
    FVA_ERROR_CANT_OPEN_OUTPUT_FILE = 1056,
};
