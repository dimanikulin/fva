 ...
 * \returns it returns empty QDateTime if loading of DateTimeOriginal not successful, otherwize it returns
 * DateTimeOriginal attribute converted to QDateTime
 */
